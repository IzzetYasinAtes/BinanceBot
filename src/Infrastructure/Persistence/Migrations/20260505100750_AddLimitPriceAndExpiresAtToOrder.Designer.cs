...
namespace BinanceBot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260505100750_AddLimitPriceAndExpiresAtToOrder")]
    partial class AddLimitPriceAndExpiresAtToOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BinanceBot.Domain.Orders.Order", b =>
                {
                    ...
                    b.HasIndex("Status", "Type", "ExpiresAt")
            ...
            modelBuilder.Entity("BinanceBot.Domain.Positions.Position", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("BreakEvenAppliedAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<decimal>("EntryCommission")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,8)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("ExitCommission")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,8)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<decimal>("ExtremeMarkPrice")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,8)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<long?>("MaxHoldDuration")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BinanceBot.Domain.RiskProfiles.RiskProfile", b =>
                {
                    ...
                    b.Property<decimal>("MaintenanceMarginRatio")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)")
                    ...
                    b.Property<decimal>("MaxFundingFeePerHour")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 6)
