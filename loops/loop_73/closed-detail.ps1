...
Write-Host "=== Tum Loop 72 PositionClosed event detayi (kronolojik) ==="
$cmd = $conn.CreateCommand()
$cmd.CommandText = "SELECT OccurredAt, PayloadJson FROM SystemEvents WHERE EventType = 'PositionClosed' AND OccurredAt > '2026-05-01 04:07' ORDER BY OccurredAt"
$r = $cmd.ExecuteReader()
$idx = 1
$total = 0
while ($r.Read()) {
...
$cmd2.CommandText = "SELECT OccurredAt, PayloadJson FROM SystemEvents WHERE EventType = 'RiskAlert' AND OccurredAt > '2026-05-01 04:07'"
